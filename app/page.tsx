      ...
      <div className={`relative z-10 pointer-events-none transition-opacity duration-500 ${isPageReady ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <main className="pointer-events-auto">
          ...
          <section className="mx-auto max-w-7xl px-4 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16">
              ...
              <div className="flex flex-col justify-center text-center lg:text-left">
                ...
                <div className="flex justify-center lg:justify-start">
                  ...
                  >
                    ...
                    <span className="font-semibold">{displayCount > 0 ? `${displayCount}+` : '3,000+'}</span> founders in database
                  </div>
                </div>
                ...
                >
                  Stop applying. Start emailing founders directly.
                </h1>

                {/* Subheadline */}
                <p className="mt-6 text-lg text-neutral-400 max-w-xl mx-auto lg:mx-0" style={{ lineHeight: '1.7' }}>
                  FounderFlow is a directory of {totalFounderCount > 0 ? `${totalFounderCount.toLocaleString()}+` : '3,000+'} early-stage startup founders with real contact info. Skip the job boards. Reach the person who actually does the hiring.
                </p>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                  {!isSignedIn ? (
                    <>
                      <Link
                        href="/opportunities"
                        className="btn btn-primary btn-lg px-10 py-4 text-base font-bold rounded-full"
                      >
                        Browse the Directory →
                      </Link>
                      <SignInButton mode="modal">
                        <button className="btn btn-ghost btn-lg px-10 py-4 text-base font-bold rounded-full">
                          Get Started Free
                        </button>
                      </SignInButton>
                    </>
                ...
                <div className="mt-6 flex flex-wrap items-center gap-2 justify-center lg:justify-start">
                  {[
                    ...
                    `${totalFounderCount > 0 ? `${totalFounderCount.toLocaleString()}+` : '3,000+'} founders listed`,
                    'Updated weekly',
                    'Free to browse',
                  ].map((label) => (
                    <span
            ...
            <div className="lg:hidden mt-10">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-neutral-500 mb-4 text-center">
                This week&apos;s founders looking to fill roles
              </p>
          ...
          <section className="mx-auto max-w-4xl px-4 py-20 sm:py-28 text-center">
            ...
            >
              The next job you get probably will not come from a job board.
            </h2>
            <p className="text-neutral-400 text-base mb-10">
              Browse {totalFounderCount > 0 ? `${totalFounderCount.toLocaleString()}+` : '3,000+'} early-stage founders for free. If you want to reach out, start a 7-day trial. No credit card needed.
            </p>
            {!isSignedIn ? (
              <SignInButton mode="modal">
